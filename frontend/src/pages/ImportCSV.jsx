...
export default function ImportCSV({ csrfToken }) {
  ...
  return (
    <div>
      ...
      <h2 className="mb-6 text-xl font-bold text-rs-red">
        Importar CSV do GAL
      </h2>
      ...
      {etapa === "upload" && (
        <div>
          <div
            ...
            className="border-2 border-dashed border-neutral-300 rounded-lg p-12 text-center cursor-pointer bg-info-50 transition-colors hover:border-info-400"
          >
            <input
              ref={inputRef}
              type="file"
          ...
          <div className="mt-6">
            <a href="/" className="text-neutral-500 text-sm underline">
              Voltar ao início
            </a>
          </div>
        </div>
      ...
      {etapa === "preview" && preview && (
        <div>
          ...
          {/* Tabela */}
          <div className="overflow-x-auto bg-white rounded-lg border border-neutral-200 mb-6">
                ...
                <tr className="bg-neutral-50 border-b-2 border-neutral-200">
                  {COLUNAS.map((col) => (
                    <th
                      ...
                      className="px-3 py-2.5 text-left font-semibold text-neutral-700 whitespace-nowrap cursor-pointer select-none"
                    >
                      {col.label}
                      <span
                  ...
                  <th className="px-3 py-2.5 text-left font-semibold text-neutral-700">
                    Ação
                  </th>
                </tr>
              </thead>
              <tbody>
                {(sortKey
                  ...
                  return (
                    <tr
                      key={i}
                      className={`border-b border-neutral-100 ${a._ignorar ? "line-through opacity-50" : ""}`}
                    >
                      <td className="px-3 py-2 text-center">
                        <span
                          className={`${st.bg} ${st.color} px-2 py-0.5 rounded text-xs font-medium whitespace-nowrap`}
                        >
                          {st.text}
                      ...
                      <td className="px-3 py-2 text-neutral-700 font-mono">
                        {a.codigo_interno || "—"}
                      </td>
                      <td className="px-3 py-2 text-neutral-700">
                        {a.nome_paciente}
      ...
      {etapa === "resultado" && resultado && (
        <div>
          <div className="bg-success-50 border border-success-200 rounded-lg p-6 mb-6">
            <h3 className="text-success-700 font-bold mb-4">
          ...
          <Button onClick={resetar} variant="primary" size="md">
...
function Contador({ label, valor, color = "text-white", bg = "bg-rs-red" }) {
  return (
